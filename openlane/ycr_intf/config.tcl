...
set ::env(VERILOG_FILES) "\
        ...
        $::env(DESIGN_DIR)/../../src/cache/src/core/dcache_top.sv        \
        $::env(DESIGN_DIR)/../../src/cache/src/core/dcache_tag_fifo.sv   \
        $::env(DESIGN_DIR)/../../src/cache/src/core/icache_tag_fifo.sv   \
        $::env(DESIGN_DIR)/../../src/cache/src/core/icache_top.sv        \
        $::env(DESIGN_DIR)/../../src/cache/src/core/icache_app_fsm.sv    \
        $::env(DESIGN_DIR)/../../src/lib/ycr_async_wbb.sv                \
	    $::env(DESIGN_DIR)/../../src/top/ycr_dmem_wb.sv                  \
	    $::env(DESIGN_DIR)/../../src/top/ycr_intf.sv                     \
	    $::env(DESIGN_DIR)/../../src/top/ycr_sram_mux.sv                 \
        $::env(DESIGN_DIR)/../../src/lib/async_fifo.sv                   \
